...
using std::tgamma;
using std::trunc;
# 2 "dft_1024/dft.cpp" 2
# 1 "dft_1024/dft.h" 1

typedef float DTYPE;

__attribute__((sdx_kernel("dft", 0))) void dft(DTYPE XX_R[1024], DTYPE XX_I[1024], DTYPE YY_R[1024], DTYPE YY_I[1024]);
# 3 "dft_1024/dft.cpp" 2
# 1 "dft_1024/coefficients1024.h" 1
...
# 4 "dft_1024/dft.cpp" 2

__attribute__((sdx_kernel("dft", 0))) void dft(DTYPE real_sample[1024], DTYPE imag_sample[1024], DTYPE real_output[1024], DTYPE imag_output[1024])
{
#line 17 "D:/1111HLS/LabB/dft_1024/dft_1024/solution1/csynth.tcl"
...
#pragma HLS ARRAY_PARTITION dim=1 factor=64 type=block variable=temp
 ...
 VITIS_LOOP_23_2: for (k = 0; k < 1024; k++){

  sum_r = 0;
  sum_i = 0;

  VITIS_LOOP_28_3: for (n = 0; n < 1024; n++){
#pragma HLS UNROLL
