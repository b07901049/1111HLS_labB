...
// ==============================================================
#ifndef __dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R_H__
#define __dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R_H__
...
struct dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R_ram) {
...
SC_MODULE(dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R) {
...
dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R_ram* meminst;


SC_CTOR(dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R) {
meminst = new dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R_ram("dft_sin_or_cos_float_s_ref_4oPi_table_100_V_ROM_1P_LUTRAM_1R_ram");
