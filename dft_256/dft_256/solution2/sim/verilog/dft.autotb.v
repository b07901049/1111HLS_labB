...
`define AUTOTB_TVIN_imag_sample_out_wrapc  "../tv/rtldatafile/rtl.dft.autotvin_imag_sample.dat"
...
`define AUTOTB_TVOUT_real_sample_out_wrapc  "../tv/rtldatafile/rtl.dft.autotvout_real_sample.dat"
`define AUTOTB_TVOUT_imag_sample_out_wrapc  "../tv/rtldatafile/rtl.dft.autotvout_imag_sample.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 331527;
...
assign arrayreal_sample_we0[0] = real_sample_we0;
assign arrayreal_sample_we0[1] = real_sample_we0;
assign arrayreal_sample_we0[2] = real_sample_we0;
assign arrayreal_sample_we0[3] = real_sample_we0;
assign arrayreal_sample_din0 = real_sample_d0;
assign arrayreal_sample_we1 = 0;
assign arrayreal_sample_din1 = 0;
assign arrayreal_sample_ready= ready;
assign arrayreal_sample_done = interface_done;
...
`AESL_MEM_imag_sample `AESL_MEM_INST_imag_sample(
    .clk        (AESL_clock),
    .rst        (AESL_reset),
    .ce0        (arrayimag_sample_ce0),
    .we0        (arrayimag_sample_we0),
    .address0   (arrayimag_sample_address0),
    .din0       (arrayimag_sample_din0),
    .dout0      (arrayimag_sample_dout0),
    .ce1        (arrayimag_sample_ce1),
    .we1        (arrayimag_sample_we1),
    .address1   (arrayimag_sample_address1),
    .din1       (arrayimag_sample_din1),
    .dout1      (arrayimag_sample_dout1),
    .ready      (arrayimag_sample_ready),
    .done    (arrayimag_sample_done)
);

// Assignment between dut and arrayimag_sample
assign arrayimag_sample_address0 = imag_sample_address0;
assign arrayimag_sample_ce0 = imag_sample_ce0;
assign arrayimag_sample_we0[0] = imag_sample_we0;
assign arrayimag_sample_we0[1] = imag_sample_we0;
assign arrayimag_sample_we0[2] = imag_sample_we0;
assign arrayimag_sample_we0[3] = imag_sample_we0;
assign arrayimag_sample_din0 = imag_sample_d0;
assign arrayimag_sample_we1 = 0;
assign arrayimag_sample_din1 = 0;
assign arrayimag_sample_ready= ready_initial | arrayimag_sample_done;
assign arrayimag_sample_done =    AESL_done_delay;
...
reg end_imag_sample;
reg [31:0] size_imag_sample;
reg [31:0] size_imag_sample_backup;
...
reg dump_tvout_finish_real_sample;

initial begin : dump_tvout_runtime_sign_real_sample
    integer fp;
    dump_tvout_finish_real_sample = 0;
    fp = $fopen(`AUTOTB_TVOUT_real_sample_out_wrapc, "wb");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_real_sample_out_wrapc);
    ...
    fp = $fopen(`AUTOTB_TVOUT_real_sample_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_real_sample_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fclose(fp);
    repeat(5) @ (posedge AESL_clock);
    dump_tvout_finish_real_sample = 1;
end


reg dump_tvout_finish_imag_sample;

initial begin : dump_tvout_runtime_sign_imag_sample
    integer fp;
    dump_tvout_finish_imag_sample = 0;
    fp = $fopen(`AUTOTB_TVOUT_imag_sample_out_wrapc, "wb");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_imag_sample_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fclose(fp);
    wait (done_cnt == AUTOTB_TRANSACTION_NUM);
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_imag_sample_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_imag_sample_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fclose(fp);
    repeat(5) @ (posedge AESL_clock);
    dump_tvout_finish_imag_sample = 1;
end
