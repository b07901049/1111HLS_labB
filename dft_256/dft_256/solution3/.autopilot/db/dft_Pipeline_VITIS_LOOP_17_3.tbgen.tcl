set moduleName dft_Pipeline_VITIS_LOOP_17_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dft_Pipeline_VITIS_LOOP_17_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ bitcast_ln20 float 32 regular  }
	{ bitcast_ln19 float 32 regular  }
	{ imag_output int 32 regular {array 256 { 0 3 } 0 1 }  }
	{ zext_ln15 int 8 regular  }
	{ real_output int 32 regular {array 256 { 0 3 } 0 1 }  }
	{ trunc_ln int 8 regular  }
	{ temp float 32 regular {array 256 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bitcast_ln20", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bitcast_ln19", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "imag_output", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "zext_ln15", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bitcast_ln20 sc_in sc_lv 32 signal 0 } 
	{ bitcast_ln19 sc_in sc_lv 32 signal 1 } 
	...
	{ zext_ln15 sc_in sc_lv 8 signal 3 } 
	{ real_output_address0 sc_out sc_lv 8 signal 4 } 
	{ real_output_ce0 sc_out sc_logic 1 signal 4 } 
	{ real_output_we0 sc_out sc_logic 1 signal 4 } 
	{ real_output_d0 sc_out sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bitcast_ln20", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bitcast_ln20", "role": "default" }} , 
 	{ "name": "bitcast_ln19", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bitcast_ln19", "role": "default" }} , 
 	...
 	{ "name": "zext_ln15", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "zext_ln15", "role": "default" }} , 
...
set Spec2ImplPortList { 
	bitcast_ln20 { ap_none {  { bitcast_ln20 in_data 0 32 } } }
	bitcast_ln19 { ap_none {  { bitcast_ln19 in_data 0 32 } } }
	...
	zext_ln15 { ap_none {  { zext_ln15 in_data 0 8 } } }
